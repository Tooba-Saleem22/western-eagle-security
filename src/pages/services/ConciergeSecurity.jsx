        ...
        <div className="max-w-7xl mx-auto space-y-24">
          ...
          <div className="border-t border-gray-100 pt-20">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl h-80 md:h-[400px] mb-12 group border border-gray-100">
              <img
                src="https://placehold.co/1600x500/111111/FFFFFF?text=Add+Concierge+Photo+Here"
            ...
            {[
              {
                ...
                text: "We provide professional concierge security services at competitive rates, delivering exceptional value without compromising on safety, reliability, or service quality.",
              },
              {
                icon: <RefreshCcw size={26} />,
                title: "Flexible Solutions",
                text: "Every property has unique security requirements. We create customized concierge security plans that adapt to your building, operations, and budget.",
              },
              {
