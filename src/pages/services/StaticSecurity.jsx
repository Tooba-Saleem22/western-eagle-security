    ...
    <div className="bg-white font-sans antialiased selection:bg-[#D4AF37]/20">
      ...
      <section className="py-20 lg:py-28 px-6 md:px-12 bg-gradient-to-b from-[#FAF8F3] to-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-12 items-center">
          ...
          {/* Right Box - Optimized Luxury White & Gold */}
          ...
          <div className="border-t border-gray-100 pt-20">
            <div className="max-w-3xl mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-[#111111] mb-4">
                Customized Static Security Services Across Alberta
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl h-80 md:h-[400px] mb-12 group border border-gray-100">
              <img
                src="https://placehold.co/1600x500/111111/FFFFFF?text=Add+Guard+Photo+Here"
            ...
            {/* Grid layout for locations/areas */}
            ...
            {[
              {
                ...
                text: "We provide professional static security services at competitive rates, delivering exceptional value without compromising on safety, reliability, or service quality.",
              },
              {
                icon: <RefreshCcw size={26} />,
                title: "Flexible Solutions",
                text: "Every property has unique security requirements. We create customized static security plans that adapt perfectly to your property, operations, and budget.",
              },
              {
                icon: <Headset size={26} />,
                title: "Exceptional Service",
                text: "Our team builds lasting relationships through clear communication, responsive 24/7 support, and a total commitment to clients.",
              },
            ].map((benefit, idx) => (
              <div
                key={idx}
