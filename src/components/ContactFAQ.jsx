  ...
  return (
    <section className="py-20 px-6 md:px-12 bg-black">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 items-start">
        {/* HELP SECTION */}
        {/* HELP SECTION */}
        <div className="md:w-[58%] relative overflow-hidden rounded-2xl border border-[#D4AF37]/20 bg-[#111111] shadow-[0_20px_60px_rgba(0,0,0,.45)]">
          {/* Background Image */}
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-black/95 via-[#0B0B0B]/90 to-black/95" />
          ...
          <div className="relative z-10 p-10 lg:p-12">
            ...
            <h2 className="mt-6 text-4xl lg:text-5xl font-bold text-white font-serif leading-tight">
              How Can We
            ...
            <p className="text-gray-400 leading-8 text-lg mb-12">
        ...
        <div className="md:w-[42%]">
          <div className="sticky top-32 bg-[#111111] border border-[#D4AF37]/20 rounded-2xl p-8 lg:p-10 shadow-[0_20px_60px_rgba(0,0,0,.45)]">
            {/* Heading */}
            ...
            <h2 className="mt-6 text-4xl font-bold text-white font-serif leading-tight">
            ...
            <div className="rounded-xl border border-[#D4AF37]/20 bg-[#0B0B0B] p-6 mb-8">
            ...
            <form className="space-y-5">
              <input
                ...
                className="w-full rounded-lg bg-[#181818] border border-[#D4AF37]/20 px-5 py-4 text-white placeholder:text-gray-500 outline-none transition focus:border-[#D4AF37]"
              />
              ...
              <button
                type="submit"
                className="w-full rounded-lg bg-[#D4AF37] py-4 text-black font-bold text-lg transition-all duration-300 hover:bg-[#E8C766] hover:scale-[1.02] shadow-[0_10px_30px_rgba(212,175,55,.30)]"
              >
                Request Free Quote
              </button>
            </form>
