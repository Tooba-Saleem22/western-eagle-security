    ...
    <section className="bg-white py-24 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="mt-6 text-4xl md:text-5xl font-bold text-[#111111] font-serif">
            Our Security
            <span className="text-[#D4AF37]"> Services</span>
          </h2>

          <div className="w-20 h-[2px] bg-[#D4AF37] rounded-full mx-auto mt-6"></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                className="group bg-[#FCFCFC] border border-[#D4AF37]/20 rounded-2xl p-8 transition-all duration-300 hover:-translate-y-3 hover:border-[#D4AF37] hover:shadow-xl"
              >
                {/* Icon */}
